...
.stage__box--current-group .stage__group { background: rgba(56, 189, 248, 0.35); color: inherit; border-radius: 999px; padding: 0.25rem 1rem; letter-spacing: 0.18em; text-transform: uppercase; font-weight: inherit; }
...
.stage__box--next-group .stage__group { background: rgba(250, 204, 21, 0.3); color: inherit; border-radius: 999px; padding: 0.25rem 1rem; letter-spacing: 0.18em; text-transform: uppercase; font-weight: inherit; }
