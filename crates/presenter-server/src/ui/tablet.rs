    ...
    view! {
        <html lang="en">
            <head>
                ...
                // PWA Manifest
                <link rel="manifest" href="/ui/tablet/manifest.json" />
                // iOS
                <meta name="apple-mobile-web-app-capable" content="yes" />
                <meta name="apple-mobile-web-app-status-bar-style" content="black-translucent" />
                <meta name="apple-mobile-web-app-title" content="Bible Tablet" />
                <link rel="apple-touch-icon" href="/ui/tablet/apple-touch-icon.png" />
                // Android
